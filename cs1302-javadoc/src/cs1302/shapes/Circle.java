...
public class Circle {
    ...
    /**
     * Sets the radius of the {@code Circle}.
     * @param radius is the user set radius
     * @throws Exception if {@code radius} is negative
     */
    ...
    /**
     * Computes are returns the Diameter of this {@code Circle} based on
     * its computed radius as returned by {@link #getRadius()} method.
    ...
    /**
     * Computer and returns the Area of the {@code Circle} based on
     * its computed radius as returned by {@link #getRadius()} method.
